...
function [NL, EL] = mesh_mk(a,b,p,m, R)
...
% for i = size(node_array,1) - sections : size(node_array,1)
%     counter = counter + 1;
%     element = [node_array(i,1) node_array(counter,1)];
%     EL = [EL ; element];    
% end
